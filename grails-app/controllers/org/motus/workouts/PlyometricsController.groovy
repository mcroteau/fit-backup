...
class PlyometricsController {
	...
	def entry(Long id){
		withPlannedWorkout { plyometricsInstance ->
    ...
    def list(Integer max) {
		authenticated { subject -> 
        	...
        	[plyometricsInstanceList: Plyometrics.list(params), plyometricsInstanceTotal: Plyometrics.count()]
		}
    }
	...
	def skip(Long id){
		withPlannedWorkoutSkipped { plyometricsInstance ->
	...
	def recover(Long id){
		withPlannedWorkoutRecovered { plyometricsInstance ->
    ...
    def update(Long id, Long version) {
		withPlannedWorkoutUpdated { plyometricsInstance ->
