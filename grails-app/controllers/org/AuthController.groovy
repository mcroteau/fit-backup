...
class AuthController {
    ...
    def signIn () {
		...
		//def authToken = new UsernamePasswordToken(json.username, json.password as String)
        ...
        try{
			...
			loginLog.account = Account.findByUsername(params.username)
			loginLog.save(flush:true)
			
			
            redirect(uri: targetUri)		
			//render authToken as JSON
