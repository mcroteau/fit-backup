...
<center><a href="javascript:" alt=""><IMG id="" src="${imageLocation}" BORDER="0" title="Application"  alt="" align="center"></a></center>
</td>
</tr>
		...
		<div class="resetForm">
			<p class="large" style="font-size:17px; line-height:1.5em;text-decoration:none;margin:10px auto 30px auto;">
				...
				<span class="small">This email has been sent to inform you that you have successfully registered ...</span>
				  <a href="javascript:" class="button blue small">Start Logging Your Results</a>
			</p>
		</div>
...
<span style="font-size:10px;color:#333333;line-height:1.3em; padding:10px;">


<br /><br/>
Copyright (C) 2013 App. All rights reserved.<br />
<br />
